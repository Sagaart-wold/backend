...
Добавить оплату, чтобы можно было оплатить товары, добавленные в корзину
...
5. **Добавление объекта в корзину**
* `api/v1/artobjects/{id}/shopping_cart/` (**POST, DELETE**): 
* добавить или удалить артобъект из списка покупок по id.

**Пример запроса**
```
POST api/v1/artobjects/{id}/shopping_cart/
...
DEL api/v1/artobjects/{id}/shopping_cart/
Права доступа: Авторизованный пользователь.
Response:
204
``` 
...
``` 
7. **Справочник городов (упрощенный вариант справочника адресов)**
