...
Планировали реализовать добавление объекта и художника в избранное
Добавление объекта в корзину, оплата. Статусы в объекте ShoppingCart меняются в зависимости от оплаты и доставки.
...
В аналитике сбор данных от пользователя и прогнать через программу заказчика, на выходе цена объекта
